...
Route::prefix('cargos')->controller(CargoController::class)
    ->group(function () {
    ...
    Route::prefix('clientes')->controller(ClienteController::class)
    ->group(function () {
    ...
    Route::prefix('enderecos')->controller(EnderecoController::class)
    ->group(function () {
    ...
    Route::prefix('produtos')->controller(ProdutoController::class)
    ->group(function () {
    ...
    Route::prefix('tamanhos')->controller(ProdutoTamanhoController::class)
    ->group(function () {
